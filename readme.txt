...
The Find Me On sidebar widget displays icons for all of your social network profiles. Includes *37* Social Network options, 16px or 32px icon size, mouseover higlight on/off, and seamless compatibility with both Social Links and About Me.  
...
*** ALERT: If you have the 'Social Links' or 'About Me' plugin installed, disable them before installing this plugin  ***
1. Download the my-social-networks.zip file.
2. From your WordPress dashboard, click 'Plugins' \ 'Add New' \ Browse to my-social-networks.zip \ 'Install Now.'
